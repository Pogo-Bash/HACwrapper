...
async function viewClassDetails(className: string) {
  ...
  try {
    ...
    console.log('Has assignments?', data.assignments)
        ...
        <div class="flex-1 overflow-y-auto p-6">
          ...
          <div v-else-if="selectedClassDetails" class="space-y-6">
            ...
            <div class="bg-blue-50 rounded-lg p-4 flex justify-between items-center">
              <div>
                <p class="text-sm text-gray-600">Marking Period Average</p>
            ...
            <div v-else>
              <p class="text-gray-500 text-center py-8">No assignments found for this class.</p>
            </div>
